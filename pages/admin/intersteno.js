...
export default function InterstenoManager() {
  const [items, setItems] = useState([
    { id: 1, title: 'İntersteno Hakkında', content: 'İntersteno hakkında bilgi...', date: '2024-01-01', order: 1 },
    { id: 2, title: 'İntersteno Onursal Başkanları', content: 'Onursal başkanlar...', date: '2024-01-01', order: 2 },
    { id: 3, title: 'İntersteno Yönetim Kurulu', content: 'Yönetim kurulu üyeleri...', date: '2024-01-01', order: 3 },
    { id: 4, title: 'İntersteno Konseyi', content: 'Konsey üyeleri...', date: '2024-01-01', order: 4 },
    { id: 5, title: 'İntersteno Türk Hakkında', content: 'Türkiye hakkında...', date: '2024-01-01', order: 5 },
    { id: 6, title: 'İntersteno-Türk Yönetimi', content: 'Yönetim bilgileri...', date: '2024-01-01', order: 6 },
  ]);
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <button onClick={openAddModal} className="bg-sky-600 text-white px-4 py-2 rounded-lg font-bold hover:bg-sky-700">
          + Yeni İçerik Ekle
        </button>
      </div>
